...
function Home() {
  ...
  const [currentX, setCurrentX] = useState('/krzyzykTop.png');

  const [modelPath, setModelPath] = useState('/kolko.glb'); 
        ...
        <div className="row">
          <div className="col-md-6 left-side animate__animated animate__fadeInLeft">
            ...
            <div className="skin-thumbnail O"
              style={{ backgroundImage: "url('/kolko.png')" }}
              ...
              onClick={() => {handleSkinChange('/krzyzyk.glb'); handleX('/krzyzykTop.png');}}>&nbsp;</div>
              <div className="skin-thumbnail X"
          ...
          <div className="col-md-6 right-side animate__animated animate__fadeInRight">
            ...
            state={{
              currentX: currentX,
              currentO: currentO,
            }}><div className="box">Timer</div></Link>
